    ...
    <div class="container tw-max-w-5xl">
        <div class="row">
            <div class="container text-center">
                <p class="lead tw-text-4xl tw-font-bold mt-3"><b>{{ $audio->name }}</b></p>
                <hr class="my-2">
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="jumbotron container p-4 mb-0 mt-0">
            ...
            <div class="col">
                ...
                <form>
                    <div class="mt-2 mb-2 tw-font-serif tw-text-lg pr-0">
                        <div class="form-group">
                            <textarea id="transcriptEditText" class="form-control bg-light p-4 tw-text-black mb-0" style="resize: none; min-height: 500px; max-height: calc(100vh - 150px); overflow-y: auto" rows="23">{!! e($audio->transcript_text) !!}</textarea>
                        </div>
                    </div>
              </form>
            </div>
